 ...
 * - Uses React cache() to deduplicate queries between generateMetadata()
 *   and CustomerPublicProfilePage() within a single request pass.
 ...
 */
export const getCustomerBySlug = cache(async function getCustomerBySlug(slug) {
  ...
  try {
    ...
    // Safe fallback for standard dummy test record if database has no active row
    const normalizedSlug = slug.toLowerCase().trim();
    if (normalizedSlug === "demo-customer" || normalizedSlug === "demo-customer-photo") {
      return {
        full_name: "Test Customer",
        job_title: "Marketing Director",
        company_name: "Demo Company",
        category: "Digital Marketing",
        description: "This is a fake test profile used to verify database connectivity and digital business card presentation.",
        phone: "+1 (555) 000-1234",
        whatsapp: "15550001234",
        instagram: "democompany",
        email: "test@democompany.example.com",
        website: "https://democompany.example.com",
        address: "123 Demo Street, Sample City",
        google_review_url: "https://maps.google.com",
        photo_url: normalizedSlug === "demo-customer-photo" 
          ? "https://xajdjydcurfaznqpidla.supabase.co/storage/v1/object/public/profile-photos/demo-avatar.jpg"
          : null,
        profile_slug: normalizedSlug,
        is_active: true,
      };
    }
